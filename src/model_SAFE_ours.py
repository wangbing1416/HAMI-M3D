...
class CNN_Fusion(nn.Module):
    ...
    def forward(self, text, image, mask):
        ...
        final = torch.cat((text_image, forgery_z, intent_z), dim=1)
        # Fake or real
        ...
        return class_output, text_image, image_z, text_z, torch.cat([sim.unsqueeze(1), (1 - sim).unsqueeze(1)], dim=1), forgery_pred, intent_pred
